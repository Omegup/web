    ...
    <>
      ...
      <BulleContainer>
        <Bulle center={positions[0] === 'center'}>
          ...
          <Circle size="80px" marginLeft="41.7%" borderColor="#FC7557" backgroundImage="src/p3.png" />
          <TextCenter>
            <h3>John Smith</h3>
        ...
        <Bulle center={positions[1] === 'center'}>
          ...
          <Circle size="80px" marginLeft="42%" borderColor="#949CFF" backgroundImage="src/p2.png" />
          <TextCenter>
            <h3>Sarah Johnson</h3>
        ...
        <Bulle center={positions[2] === 'center'}>
          ...
          <Circle size="80px" marginLeft="44%" borderColor="#FEC63A" backgroundImage="src/p1.png" />
          <TextCenter>
            <h3>Alex Turner</h3>
      ...
      <FlecheContainer>
        <FlecheButton backgroundImage="src/arrow-left.png" onClick={tourneGauche} />
        <FlecheButton backgroundImage="src/arrow-right.png" onClick={tourneDroite} />
      </FlecheContainer>
    </>
  );
}
